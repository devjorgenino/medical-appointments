...
import {
  useFormValidation,
  createRegisterFormValidationConfig,
...
const RegisterPage: React.FC = () => {
  ...
  const handleFieldChange = <K extends keyof RegisterFormData>(
    ...
    const updatedForm: RegisterFormData = {
      ...formData,
      [fieldName]: value,
    };
  ...
  return (
    <div className="flex items-center justify-center min-h-screen p-4 bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800 transition-colors duration-300">
      ...
      <div className="w-full max-w-2xl p-8 bg-white dark:bg-gray-800 rounded-lg shadow-lg dark:shadow-2xl dark:shadow-black/20 border border-transparent dark:border-gray-700/50 transition-colors duration-300">
        <div className="mb-8 text-center">
          ...
          <p className="mt-2 text-gray-600 dark:text-gray-400">Registrarse</p>
        </div>
            ...
            <div className="md:col-span-2">
              <FormField
                ...
                onChange={(e) => {
                  handleFieldChange(
                    "sexo",
                    e.target.value as RegisterFormData["sexo"]
                  );
                }}
                onBlur={() => {
                  handleBlur("sexo");
            ...
            <div className="relative mb-4">
              <label
                ...
                className={`block mb-1 text-sm font-medium ${
                  errors.password ? "text-red-700 dark:text-red-400" : "text-gray-700 dark:text-gray-300"
                }`}
              >
                Contrasena
              ...
              <div className="relative">
                <input
                  ...
                  required
                  className={`w-full px-3 py-2 pr-12 border rounded-md shadow-sm focus:outline-none bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 transition-colors ${
                    errors.password
        ...
        <footer className="mt-6 text-sm text-center text-gray-500 dark:text-gray-500">
