...
export interface ValidationRule {
  validator: (value: any, data?: any) => string;
  required?: boolean;
}
...
interface UseFormValidationReturn<T extends Record<string, unknown>> {
  ...
  validateField: (fieldName: string, value: T[keyof T], data?: T) => void;
...
export function useFormValidation<T extends Record<string, any>>(
  ...
  const validateField = useCallback(
    (fieldName: string, value: T[keyof T], data?: T) => {
...
export function createUserFormValidationConfig(isCreation: boolean = true) {
  return {
    email: {
      validator: (value: any) => validateEmail(value || "", true),
      required: true,
    },
    password: {
    ...
    nombre: {
      validator: (value: any) => validateName(value || "", "nombre", true),
      required: true,
    },
    apellido: {
      validator: (value: any) => validateName(value || "", "apellido", true),
      required: true,
    },
    numero_telefono: {
      validator: (value: any) => validatePhone(value || "", false),
      required: false,
    },
    direccion: {
      validator: (value: any) => validateAddress(value || "", false),
      required: false,
    },
    sexo: {
      validator: (value: any) => validateSex(value || "", true),
      required: true,
    },
    role_id: {
      validator: (value: any) => validateRole(value, true),
      required: true,
    },
    especialidad: {
      validator: (value: any, data?: any) => {
...
export function createRegisterFormValidationConfig() {
  return {
    ...
    password: {
      validator: (value: any) => validatePassword(value || "", true),
      required: true,
    },
    nombre: {
      validator: (value: any) => validateName(value || "", "nombre", true),
    ...
    numero_telefono: {
      validator: (value: any) => validatePhone(value || "", true),
      required: true,
    },
    direccion: {
      validator: (value: any) => validateAddress(value || "", true),
      required: true,
    },
    sexo: {
      validator: (value: any) => validateSex(value || "", true),
