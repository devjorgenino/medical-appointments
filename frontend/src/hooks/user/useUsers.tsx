...
const useUsers = (userRoleId: number): UseUsersReturn => {
  ...
  const fetchUsers = useCallback(async () => {
    ...
    try {
      ...
      if (
        ...
        console.error("Error al obtener usuarios:", detail || (error as unknown as Error).message)
      } else {
        toast.error("Error al obtener usuarios")
  ...
  const handleDelete = async (id: number) => {
    ...
    try {
      ...
      if (
        ...
        console.error("Error al eliminar usuario:", (error.response.data as { detail?: string }).detail)
      } else {
        toast.error("Error al eliminar usuario")
